...
var getFeaturedContent = function(){
    ...
    var my_json;
    $.getJSON('http://younge.thecompleteexperience.ca/api/photos', function(json) {
      my_json = json;
        ...
        var i=0;
            ...
            // $('#feature').append(
            //    // "<div style='float: left; height: 727px; width:100%; background:url(http://younge.thecompleteexperience.ca/timthumb.php?src=/images/feature/"+my_json[1].path+"&w=1280&h=727.jpg) top left no-repeat;'><div class='content'><div id='ribbon'>Featured Athletes</div><h1>"+my_json[1].title+"</h1><p>"+my_json[1].content+"</p></div></div>"
            //    //"<div style='height: 100%; width: 100%; background: url(http://younge.thecompleteexperience.ca/timthumb.php?src=/images/feature/"+element.path+"&w=1000.jpg)></div>"
        ...
        $('#feature').append(
           //"<div style='float: left; height: 727px; width:100%; background:url(http://younge.thecompleteexperience.ca/timthumb.php?src=/images/photos/"+my_json[display].path+"&w=1280&h=727.jpg) top left no-repeat;'><div class='content'><div id='ribbon'>Featured Athletes</div><h1>"+my_json[display].title+"</h1><p>"+my_json[display].content+"</p></div></div>"
           "<div style='float: left; height: 727px; width:100%; background:url(http://younge.thecompleteexperience.ca/timthumb.php?src=/images/photos/"+my_json[display].path+"&w=1280&h=727.jpg) top left no-repeat; position: absolute; top: 0; left: 0;'><div class='splash-content'><h1 class='splash-title'>Community Board</h1>"+splash+"</div></div>"
           //"<div style='height: 100%; width: 100%; background: url(http://younge.thecompleteexperience.ca/timthumb.php?src=/images/feature/"+element.path+"&w=1000.jpg)></div>"
...
var getCalendar = function(){
    ...
    $('.calendar').load("http://younge.thecompleteexperience.ca/api/calendar", function(){  
...
var getInteractiveFlyer = function(){
    $('#flyer').load("http://younge.thecompleteexperience.ca/int-flyer.php");
}
            ...
            var setupScores = function(){
                ...
                $(d).find('game').each(function(){  
                    ...
                    if( prevsport != sport ){
                        ...
                        $('#masterscoretable').append("<div class='sport-row'><img src='http://younge.thecompleteexperience.ca/images/"+sport+"/logo_"+sport+"_sm.png' /><span class='sport-title'>"+sport+" SCOREBOARD</span></div>");
                    } 
                    ...
                    // html +=   "<tr>";
                    // //html +=    "<td rowspan='2' class='league'><img src='http://younge.thecompleteexperience.ca/images/"+sport+"/logo_"+sport+"_sm.png' /></td>";
    ...
    $.getJSON('http://younge.thecompleteexperience.ca/api/photos', function(json) {
      my_json = json;
        ...
        $.each(my_json, function(index, element) {
            ...
            $('#photos').append(
               // "<div class='person'><a href=javascript:showPerson(`"+element.first+"`,`"+element.last+"`,`"+element.position+"`,`"+element.photo+"`,`"+element.bio+"`,`"+element.favorite_sport+"`);><img src='http://younge.thecompleteexperience.ca/timthumb.php?src=/images/staff/"+element.photo+"&amp;w=124&amp;h=158&amp;a=br'></a></div>"
               "<a class='fancybox' href='http://younge.thecompleteexperience.ca/timthumb.php?src=/images/photos/"+element.path+"&w=1000.jpg'><img src='http://younge.thecompleteexperience.ca/timthumb.php?src=/images/photos/"+element.path+"&w=300&h=200.jpg'></a>"

               // http://younge.thecompleteexperience.ca/timthumb.php?src=/images/photos/2bb5744e059a7a8a3f442ca4e54d108858a7097d.jpg&w=1000.jpg
            );
...
var getStaff = function(){
    ...
    var my_json;
    $.getJSON('http://younge.thecompleteexperience.ca/api/staff', function(json) {
      my_json = json;
        ...
        $('.selected').append(
            "<div style='height: 727px; width: 100%; background:url(http://younge.thecompleteexperience.ca/timthumb.php?src=/images/staff/"+first_photo+"&amp;w=745&amp;h=727&amp;a=br);'><div class='staff-bio'><div class='staff-bio-content'><h1>"+first_first+" "+first_last+"</h1><h2>"+first_pos+" <span class='fav-sport'>❤ Sport: "+first_sport+"</span></h2><p>"+first_bio+"</p></div></div></div>"
        );
        ...
        $.each(my_json, function(index, element) {
            ...
            $('.staff').append(
               // "<div class='person'><a href=javascript:showPerson(`"+element.first+"`,`"+element.last+"`,`"+element.position+"`,`"+element.photo+"`,`"+element.bio+"`,`"+element.favorite_sport+"`);><img src='http://younge.thecompleteexperience.ca/timthumb.php?src=/images/staff/"+element.photo+"&amp;w=124&amp;h=158&amp;a=br'></a></div>"
               "<div class='person'><a href=javascript:showPerson("+i+");><img src='http://younge.thecompleteexperience.ca/timthumb.php?src=/images/staff/"+element.photo+"&amp;w=124&amp;h=158&amp;a=br'></a></div>"
            );
...
var showPerson = function(i){
    ...
    $.getJSON('http://younge.thecompleteexperience.ca/api/staff', function(json) {
      my_json = json;
       ...
       // $('.selected').fadeIn(600, function() { $(this).append("<div style='height: 727px; width: 100%; background:url(http://younge.thecompleteexperience.ca/timthumb.php?src=/images/staff/"+photo+"&amp;w=745&amp;h=727&amp;a=br);'><h1>"+first+" "+last+"</h1><p>"+bio+"</p></div>")   });

        $('.selected').append("<div style='height: 727px; width: 100%; background:url(http://younge.thecompleteexperience.ca/timthumb.php?src=/images/staff/"+photo+"&amp;w=745&amp;h=727&amp;a=br);'><div class='staff-bio'><div class='staff-bio-content'><h1>"+first+" "+last+"</h1><h2>"+pos+" <span class='fav-sport'>❤ Sport: "+sport+"</span></h2><p>"+bio+"</p></div></div>></div>");
        $('.selected div').hide();
